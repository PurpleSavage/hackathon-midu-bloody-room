export function GameIconsChewedSkull(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      style={{
        clipPath: 'url(#clip)',
        animation: 'reveal 2s ease-in-out forwards', // Controla la duración y el tipo de animación
      }}
    >
      <defs>
        <clipPath id="clip">
